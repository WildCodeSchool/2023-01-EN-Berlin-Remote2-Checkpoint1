...
function findAdults(arr) {
  // Your code here !
  let adultFemales = arr.filter(function(person) {return person.age > 18 && person.sex === "female";});
  let adultMales = arr.filter(function(person) {return person.age > 18 && person.sex === "male";});
